...
#define AM_FREERTOS_CTIMER_NUM 	2
...
//			__isb( portSY_FULL_READ_WRITE );
        ...
        Delta_Sleep = (signed long) New_Timer - (signed long) Old_Timer;
#else
        am_hal_ctimer_stop(AM_FREERTOS_CTIMER_NUM, AM_HAL_CTIMER_BOTH);
...
am_stimer_cmpr0_isr(void)
{
    ...
    //
    //ui32Status = am_hal_stimer_int_status_get(false);
