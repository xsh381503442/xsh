...
//字体大小
typedef enum {							//		中文		英文		数字1			数字2
	LCD_FONT_8_SIZE				= 8U,	//8#							4X12(自制)		4X12(自制)
	LCD_FONT_9_SIZE				= 9U,
	...
	LCD_FONT_14_SIZE			= 14U,	//14#											10X14(自制)
	LCD_FONT_16_SIZE			= 16U,	//16#	16X16(宋体)	8X16(宋体)	6X17(自制)		8X16(自制)
	
	LCD_FONT_16_1_SIZE			= 17U,
	LCD_FONT_17_SIZE			= 18U,	//17#	12X17(自制)		
//	LCD_FONT_18_SIZE			= 18U,	//18#	12X18(自制)								6X17(自制)
    LCD_FONT_19_SIZE			= 19U,
	LCD_FONT_20_SIZE			= 20U,	//20#											8X20(自制)
	LCD_FONT_24_SIZE			= 24U,	//24#	24X24(宋体)	12X24(宋体)	10X25(自制)		12X28(自制)
	LCD_FONT_25_SIZE			= 25U,
    LCD_FONT_29_SIZE			= 29U,
	LCD_FONT_32_SIZE			= 32U,	//32#	32X32(宋体)	16X32(宋体)	14X38(自制)		16X36(自制)
    LCD_FONT_37_SIZE			= 37U,
    
    LCD_FONT_41_SIZE			= 41U,
	LCD_FONT_47_SIZE			= 47U,	//48#							17X45(自制)		26X56(自制)
	LCD_FONT_48_SIZE			= 48U,	//48#							17X45(自制)		26X56(自制)
	
    LCD_FONT_49_SIZE            = 49U,
	LCD_FONT_56_SIZE			= 56U,
	//LCD_FONT_64_SIZE			= 64U,	//64#											30X64(自制)
    LCD_FONT_66_SIZE			= 66U,
    LCD_FONT_dial_72_SIZE       = 71U,
	LCD_FONT_72_SIZE			= 72U,
    LCD_FONT_dial_73_SIZE       = 73U,
	LCD_FONT_88_SIZE			= 88U,	//88#							29X90(自制)		40X86(自制)
