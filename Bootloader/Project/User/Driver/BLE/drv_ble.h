...
#define DRV_BLE_UART_MOUDLE                       BSP_APOLLO2_DRV_BLE_UART_MOUDLE
#define DRV_BLE_UART_TX_PIN                       BSP_APOLLO2_DRV_BLE_UART_TX_PIN
#define DRV_BLE_UART_RX_PIN                       BSP_APOLLO2_DRV_BLE_UART_RX_PIN
#define DRV_BLE_UART_CTS_PIN                      BSP_APOLLO2_DRV_BLE_UART_CTS_PIN
#define DRV_BLE_UART_RTS_PIN                      BSP_APOLLO2_DRV_BLE_UART_RTS_PIN
#define DRV_BLE_POLARITY_CTS_PIN                  BSP_APOLLO2_DRV_BLE_POLARITY_CTS_PIN
