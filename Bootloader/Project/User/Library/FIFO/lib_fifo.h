 ...
 * @retval     ERR_NULL           If a NULL pointer is provided as buffer.
 * @retval     ERR_INVALID_LENGTH If size of buffer provided is not a power of two.
 */
 ...
 * @retval     ERR_NO_MEM         If the FIFO is full.
 */
 ...
 * @retval     ERR_NOT_FOUND      If there is no more elements in the queue.
 */
