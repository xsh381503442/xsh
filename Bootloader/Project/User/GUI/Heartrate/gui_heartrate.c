...
#define MOUDLE_NAME                     "[GUI_HEARTRATE]:"
...
static void title(void)
{
	...
	char p_char[] = "HEARTRATE";	
	lib_display_ascii(p_char, strlen(p_char), &param);	
}

void gui_heartrate_paint(void)
{
	DEBUG_PRINTF(MOUDLE_NAME"gui_heartrate_paint\n");
...
void gui_heartrate_btn_evt(uint32_t evt)
{
	switch(evt)
	{		
		case (BTN_PIN_PWR):{
