...
* @retval	1 -> Error
*/
BSX_S8 bsx_init_acc(BSX_U8* p_accelspec);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_accrange(BSX_U8 measrange);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accrange(BSX_U8 *measrange);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_accdatarate(BSX_U8 accDataRate);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accdatarate(BSX_U8 *accDataRate);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_acccalib_accuracythreshold(BSX_U8 accThreshold);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_acccalibprofile(ts_calibprofile *calibprofile);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_acccalibprofile(ts_calibprofile *calibprofile);
 ...
 * @retval	1 -> Error
 */
BSX_S8  bsx_set_stepdetectionopmode(BSX_U8 Opmode);
...
* @retval	1 -> Error
 */
BSX_S8  bsx_get_stepdetectionopmode(BSX_U8 *Opmodestatus);
...
* @retval	1 -> Error
 */
BSX_S8  bsx_set_stepeventdetectionopmode(BSX_U8 eventstate);
 ...
 * @retval	1 -> Error
 */
BSX_S8 bsx_get_stepdetectionrobustness(BSX_U8 *robuststatus);
 ...
 */
BSX_S8  bsx_get_stepdetectionstatus(BSX_U8 *activity);
 ...
 * @retval	1 -> Error
 */
BSX_S8  bsx_get_stepcount(BSX_U64 *steps);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_acccordata(ts_dataxyzf32 *corAccData);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accfiltdata1(ts_dataxyzf32 *filtaccdata);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accfiltdata2(ts_dataxyzf32 *filtAccData);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accoffset(ts_dataxyzf32 *offset);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_acccalibaccuracy(BSX_U8 *calibaccuracy);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accrawdata_mg(ts_dataxyzf32 *rawdata_mg );
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_acccordata_mg(ts_dataxyzf32 *cordata_mg );
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accfiltdata1_mg(ts_dataxyzf32 *filtdata1_mg );
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accfiltdata2_mg(ts_dataxyzf32 *filtdata2_mg );
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_accoffsets_mg(ts_dataxyzs32 *accoffsets_mg );
...
* @retval	1 -> Error
*/
BSX_S8 bsx_init_mag(BSX_U8 *p_magspec);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_magdatarate(BSX_U8 magdatarate);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_updatefmcparam(BSX_U8 datarate);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_magdatarate(BSX_U8 *dataRate);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_magcalib_processnoise( BSX_F32 *processNoise);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_magcalib_processnoise( BSX_F32 *processNoise);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_set_softiron_correctionmatrix(ts_sensmatrix correctMatrix);
...
* @retval	1 -> Error
*/
BSX_S8 bsx_get_softiron_correctionmatrix(ts_sensmatrix *correctMatrix);
/************************************************************************************************************/
