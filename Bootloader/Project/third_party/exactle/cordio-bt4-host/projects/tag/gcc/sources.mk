...
C_FILES += \
    $(ROOT_DIR)/sw/apps/tag/tag_main.c \
    $(ROOT_DIR)/sw/profiles/fmpl/fmpl_main.c \
    $(ROOT_DIR)/sw/profiles/gap/gap_main.c \
    $(ROOT_DIR)/sw/profiles/gatt/gatt_main.c \
    $(ROOT_DIR)/sw/services/svc_px.c 

INC_DIRS += \
    $(ROOT_DIR)/sw/apps/tag \
    $(ROOT_DIR)/sw/profiles/fmpl \
    $(ROOT_DIR)/sw/profiles/gap \
    $(ROOT_DIR)/sw/profiles/gatt \
    $(ROOT_DIR)/sw/profiles/tag
...
C_FILES   += \
    ...
    $(ROOT_DIR)/cordio-bt4-host/projects/tag/main.c
