...
**------------------------------------------------------------------------------------------------*/
int Util_VSNPrintf(char *s, uint32_t size, const char *format, va_list ap) PRINTF_ATTRIBUTE(3, 0);
...
** RETURNS:     Number of characters stored in s
**------------------------------------------------------------------------------------------------*/
int Util_SNPrintf (char *s, uint32_t size, const char *format, ...) PRINTF_ATTRIBUTE(3, 4);
