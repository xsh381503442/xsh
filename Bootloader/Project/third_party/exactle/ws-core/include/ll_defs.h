 ...
 *
 *  $Date: 2016-08-29 08:21:54 -0700 (Mon, 29 Aug 2016) $
 *  $Revision: 8621 $
 *
...
/*! \brief      Link Layer version values. */
enum
{
  LL_VER_BT_CORE_SPEC_4_0       = 0x06, /*!< Bluetooth core specification 4.0 */
  LL_VER_BT_CORE_SPEC_4_1       = 0x07, /*!< Bluetooth core specification 4.1 */
  LL_VER_BT_CORE_SPEC_4_2       = 0x08, /*!< Bluetooth core specification 4.2 */
  LL_VER_BT_CORE_SPEC_5_0       = 0x09  /*!< Bluetooth core specification 5.0 */
};

/*! \brief      Company identifiers. */
enum
{
  LL_COMP_ID_WICENTRIC          = 0x005F /*!< Wicentric company ID. */
};
...
#define LL_ADVB_MAX_TIME        ((8 * (LL_ADVB_MAX_LEN)) + LL_MIN_PKT_TIME_US_1M)
                                        /*!< Maximum time for a advertising channel PDU. */

#define LL_ADV_PKT_MAX_USEC     LL_ADVB_MAX_TIME    /*!< Maximum time in microseconds for an advertising packet. */
...
#define LL_SCAN_RSP_MAX_USEC    LL_ADVB_MAX_TIME    /*!< Maximum time in microseconds for a scan response packet. */
...
#define LL_MAX_ADV_SET_ID       0xEF    /*!< Maximum advertising set ID. */
...
#define LL_EXT_ADV_DATA_MAX_LEN 254     /*!< Maximum extended advertising data length. */

#define LL_EXT_ADV_PDU_MAX_LEN  (LL_ADV_HDR_LEN + LL_EXT_ADV_HDR_MIN_LEN + LL_EXT_ADV_DATA_MAX_LEN)
                                        /*!< Maximum extended advertising PDU length. */
...
enum
{
  ...
  LL_MIN_USED_CHAN_IND          = 0x19, /*!< Minimum used channels indication PDU. */
...
#define LL_MIN_USED_CHAN_PDU_LEN    2   /*!< Minimum used channels indication PDU length. */ 
...
#define LL_DATA_LEN_TO_TIME_1M(len) ((8 * ((len) + 4)) + LL_MIN_PKT_TIME_US_1M)
                                        /*!< Convert data length to time. */
#define LL_DATA_LEN_TO_TIME_2M(len) ((4 * ((len) + 4)) + LL_MIN_PKT_TIME_US_2M)
                                        /*!< Convert data length to time. */
...
#define LL_MAX_DATA_TIME_ABS_MAX 2120   /*!< Absolute maximum limit for maximum Data PDU time */
...
#define LL_MIN_PKT_TIME_US_1M    80      /*!< Minimum packet time (i.e. empty PDU). */
#define LL_MIN_PKT_TIME_US_2M    44      /*!< Minimum packet time (i.e. empty PDU). */
