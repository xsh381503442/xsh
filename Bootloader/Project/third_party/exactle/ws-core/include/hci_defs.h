...
#define HCI_OCF_LE_WRITE_RF_PATH_COMP                0x4C
#define HCI_OCF_LE_READ_RF_PATH_COMP                 0x4D
#define HCI_OCF_LE_SET_PRIVACY_MODE                  0x4E
#define HCI_OCF_LE_SET_MIN_NUM_OF_USED_CH            0x4F
...
#define HCI_OPCODE_LE_SET_MIN_NUM_OF_USED_CH         HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_SET_MIN_NUM_OF_USED_CH)
...
#define HCI_LEN_LE_SET_EXT_SCAN_PARAM(numPhys)       (1 + (7 * (numPhys)))
#define HCI_LEN_LE_SET_EXT_SCAN_ENABLE               6
#define HCI_LEN_LE_EXT_CREATE_CONN(numPhys)          (13 + (13 * (numPhys)))
#define HCI_LEN_LE_PER_ADV_CREATE_SYNC               13
...
#define HCI_LEN_LE_SET_MIN_NUM_OF_USED_CH            16
...
#define HCI_LEN_LE_PER_ADV_REPORT                    7       /*!< Periodic advertising report event length. */
...
#define HCI_ADV_DIRECTED_MAX_DURATION                0x0800  /*!< Maximum high duty cycle connectable directed advertising duration */
...
#define HCI_PER_ADV_DATA_LEN                         251     /*!< Length of periodic advertising data */
#define HCI_EXT_ADV_RPT_DATA_LEN                     236     /*!< Length of extended advertising report data */
...
/* Company ID */
#define HCI_ID_WICENTRIC                             0x005F  /*! Wicentric company ID */
