...
/* UUIDs */
static const uint8_t wdxsDcUuid[] = {WDXS_DC_UUID};     /* WDX Device Configuration Characteristic */
static const uint8_t wdxsFtcUuid[] = {WDXS_FTC_UUID};   /* WDX File Transfer Control Characteristic */
static const uint8_t wdxsFtdUuid[] = {WDXS_FTD_UUID};   /* WDX File Transfer Data Characteristic */
static const uint8_t wdxsAuUuid[] = {WDXS_AU_UUID};     /* WDX Authentication Characteristic */
