 ...
 *  \param  period    Period (only applicable to AE).
 *
 *  \return None.
 */
 /*************************************************************************************************/
void DmScanStart(uint8_t scanPhys, uint8_t mode, uint8_t *pScanType, bool_t filterDup,
 ...
 */
/*************************************************************************************************/
void DmScanSetInterval(uint8_t scanPhy, uint16_t scanInterval, uint16_t scanWindow);
 ...
 *
 *  \brief  Set the Advertising, Scanning or Initiator filter policy for the given advertising
 *          set, Scanning or Initiator PHY respectively.
 *
 *  \param  handlePhy  Advertising handle, Scanning or Initiator PHY depending on policy mode.
 *  \param  mode       Policy mode.
 *  \param  policy     Filter policy.
 *
 *  \return TRUE if the filter policy was successfully set, FALSE otherwise.
 */
/*************************************************************************************************/
bool_t DmDevSetExtFilterPolicy(uint8_t handlePhy, uint8_t mode, uint8_t policy);
