...
static void medcPlxpDiscover(dmConnId_t connId);
...
static void medcPlxpProcMsg(wsfMsgHdr_t *pMsg)
{
  ...
  switch(pMsg->event)
  {
    case  DM_CONN_OPEN_IND:
      AttcMtuReq((dmConnId_t) pMsg->param, MEDC_PLX_DEFAULT_MTU);
      break;
...
static void medcPlxpInit(void)
{
  ...
  medcCb.autoUuid = ATT_UUID_PULSE_OXIMITER_SERVICE;
