...
set BOOTLOADER_VERSION=0x01010505
set APPLICATION_VERSION=0x01010801
...
nrfjprog.exe --program PCBA_Factory_Downloader\nrf_bootloader_and_application_softdevice.hex --verify
nrfjprog.exe -r
